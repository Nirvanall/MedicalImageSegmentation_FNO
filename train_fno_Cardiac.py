...
train FNO with pericardium in LDCT
...
#%%
today = date.today()
save_name = 'CardiacFat64-ReduceLROnPlateau-TFNO-32-64-128-' + str(today.strftime('%d%m%Y'))
...
#train, left = torch.utils.data.random_split(data, [8000, 1000], generator=generator)
