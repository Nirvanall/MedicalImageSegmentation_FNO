...
#%%
today = date.today()
save_name = 'Task02Heart64-256-ReduceLROnPlateau-TFNO-32-64-128-' + str(today.strftime('%d%m%Y'))
input_dir = "../datasets/Task02_Heart/imagesTr_png"
target_dir = "../datasets/Task02_Heart/labelsTr_png"
num_classes = 2
batch_size = 16
seed = 42
...
data = T2Heart(input_dir, target_dir, transform_x=PositionalEmbedding(grid_boundaries, 0) if positional_encoding else None)
generator=torch.Generator().manual_seed(seed)
train, valid = torch.utils.data.random_split(data, [1200, 151], generator=generator)
...
model_path = 'Task02Heart64-ReduceLROnPlateau-TFNO-32-64-128-23122023-best-checkpoint.pt'
