...
#%%
today = date.today()
save_name = 'Task02Heart64-ReduceLROnPlateau-TFNO-32-64-128-' + str(today.strftime('%d%m%Y'))
...
#train, valid = torch.utils.data.random_split(data, [2000, 271], generator=generator)
